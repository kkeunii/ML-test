...
window.QUESTION_UNITS.push({
  ...
  "questions": [
    ...
    },
    {
      ...
      "choices": [
        "모든 특성을 제거한 뒤 모델을 학습한다.",
        "후보 하이퍼파라미터 조합을 체계적으로 시도해 가장 좋은 조합을 찾는다.",
        "테스트 데이터만 사용해 모델을 만든다.",
        "모델의 가중치를 사람이 직접 계산한다."
      ],
      "answerIndex": 1,
    ...
    },
    {
      ...
      "choices": [
        "best_params_는 모델 이름만 알려주기 때문이다.",
        "검증 과정에서 좋은 조합일 뿐, 최종 테스트 데이터에서 다시 평가해야 하기 때문이다.",
        "best_params_는 항상 과소적합을 의미하기 때문이다.",
        "교차검증을 쓰면 테스트가 불가능하기 때문이다."
      ],
      "answerIndex": 1,
    ...
    },
    {
      ...
      "choices": [
        "0이 항상 가장 건강한 상태를 의미하기 때문이다.",
        "생리적으로 0이 나오기 어려운 값이므로 결측 또는 이상 입력일 가능성이 있기 때문이다.",
        "0은 무조건 당뇨를 의미하기 때문이다.",
        "0은 모델이 자동으로 제거하기 때문이다."
      ],
      "answerIndex": 1,
    ...
    },
    {
      ...
      "choices": [
        ...
        "Recall은 항상 Accuracy보다 크기 때문이다.",
        "Recall은 데이터 전처리와 무관하기 때문이다."
      ],
      "answerIndex": 1,
    ...
    },
    {
      ...
      "choices": [
        "하나의 모델만 최대한 깊게 학습시키는 것",
        "여러 모델의 예측을 결합해 더 안정적이고 정확한 예측을 얻는 것",
        "데이터의 라벨을 모두 제거하는 것",
        "모델 평가 지표를 하나만 사용하는 것"
      ],
      "answerIndex": 1,
    ...
    },
    {
      ...
      "choices": [
        "이전 모델이 틀린 데이터에 더 큰 가중치를 부여하며 순차 학습한다.",
        "데이터를 중복 허용해 여러 샘플로 나누고 병렬적으로 학습한 뒤 투표한다.",
        "항상 하나의 결정 경계만 만든다.",
        "검증 데이터를 사용하지 않는 방식이다."
      ],
      "answerIndex": 1,
    ...
    },
    {
      ...
      "choices": [
        "텍스트 문장의 감정을 분류하는 데이터이다.",
        "스마트폰의 가속도계와 자이로스코프 센서 데이터를 이용해 행동을 분류한다.",
        "반드시 이미지 픽셀만 사용한다.",
        "정답 라벨 없이 군집화만 수행한다."
      ],
      "answerIndex": 1,
      "explanation": "HAR 데이터는 스마트폰 센서로부터 얻은 3축 가속도와 각속도 정보를 바탕으로 걷기, 앉기, 서기, 눕기 등 사람의 행동을 분류한다. 11주차 추가 10문제: 신용카드 사기 탐지, 시각화"
    },
    {
      "id": "unit10-11",
